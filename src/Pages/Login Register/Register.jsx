        ...
        <div className='flex-1 space-y-8 md:px-8 px-4'>
          ...
          <form action="" className='flex-1' onSubmit={handleSubmit(onSubmit)}>
            <label htmlFor="" className='space-y-4'>
              ...
              <input type="email" {...register('name', {required: true})} placeholder='Enter your name' className='focus:outline-none focus:border-b focus:border-theme border-b border-b-black w-full pl-4 py-4 text-base font-normal'/>
            ...
            <label htmlFor="" className='space-y-4'>
              ...
              <input type="file" {...register('photo', {required: true})} placeholder='Enter your password' className='w-full pl-4 py-4 text-base font-normal'/>
          ...
          <p className='text-theme text-center text-xl font-medium'>Already registered? <span onClick={() => setLogin(true)} className='font-semibold cursor-pointer'>Sign in now.</span></p>
