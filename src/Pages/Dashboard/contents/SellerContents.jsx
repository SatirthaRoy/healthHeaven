...
const SellerContents = () => {
  return (
    <>
      <NavLink to='/dashboard/adminhome' className={({isActive}) => isActive ? 'underline flex gap-4 items-center text-base text-white' : `text-white flex gap-4 items-center text-base`}><FaHome className='text-2xl'/>Seller's Home</NavLink>
